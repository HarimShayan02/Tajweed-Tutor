...
const BecomeTutor = () => {
  ...
  const signUpTutor = async (fields) => {
    try {
      ...
      navigate(`/onBoarding/${tutor?.user?.id}`);
    } catch (error) {
      ...
      >
        ...
        <div className="max-w-[1180px] w-full mx-auto h-full">
          <div className="grid grid-cols-2 ">
            ...
            <div className="col-span-1">harim</div>
          </div>
        </div>
      </div>
            ...
            {Array(3)
              ...
              .map((item, index) => (
                <div className="max-w-xs " key={index}>
                  <div className="relative bg-[#efefef] border border-[#89474b] shadow-lg rounded-lg  p-5 overflow-hidden">
                    <svg
                    ...
                    <div className="py-[3rem] ">
                      <div className="text-md font-bold uppercase tracking-widest mb-2 text-black">
                        {index + 1}
                      </div>
                      ...
                      <p className="text-black">
                        ...
                        complete memorization of the Quran, our pupils search
                        for the best tutors.
                      </p>
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="col-span-1">
              <h3 className="font-bold text-white text-4xl leading-[50px] w-[90%]">
                Pay Bills, Impact Lives, and Earn Rewards in One Sitting!
              </h3>
              <p className="font-poppin text-white text-lg leading-[28px] mt-4 sm:mb-0 md:mb-6 max-w-[80%] w-auto">
                We support you throughout your tutoring journey. From providing
                access to students, to stable marketing, we optimize your
                tutoring business. Work at flexible timings, earn with comfort,
                and great a striking CV that benefits your career.
              </p>
            </div>
            <div className="col-span-1">
              <img
        ...
        <div className="max-w-[1180px] mx-auto w-full">
          ...
          <div className="grid grid-cols-5 gap-5 mt-10">
            {Array(5)
              ...
              .map((item, index) => (
                <div
                  className="col-span-1 border border-[#89474b] rounded-md min-h-[180px] h-auto"
                  key={index}
                >
                  <div className="flex flex-col gap-y-2 justify-center items-center h-full">
                    <div className="flex w-16 h-16 justify-center items-center bg-[#89474b] rounded-md">
                      <HiPhoto size={22} className="text-white" />
                    </div>
